...
<script src="/resources/js/Tianxie.js" type="text/javascript"></script>
  ...
  <body>
 <jsp:include page="/userCenter/gotoHead" />
    <div class="main" style="margin-bottom:25px;">
<jsp:include page="/userCenter/gotoLeft" />
            ...
            <p class="r_tit">账户安全</p>
                ...
                <div class="qiye">
                    ...
                    <div class="qiye_right">
                    	<a href="/userCenter/gotoXiugaimima" class="zhucek_mk colormk">修改</a>
                    </div>
                </div>
                ...
                <div class="qiye">
                    ...
                    <div class="qiye_center">
                            ...
                            <c:if test="${user.userphone==null or user.userphone eq ''}">
                               <span style="color:#C27200;">您的手机号码未验证</span>
                            </c:if>
                             <c:if test="${user.userphone!=null and user.userphone ne ''}">
                    ...
                    <div class="qiye_right">
                     <c:if test="${user.userphone==null or user.userphone eq ''}">
                        <a href="/userCenter/gotoUpdatePhone_1" class="zhucek_mk colormk">验证</a>
                     </c:if>
                      <c:if test="${user.userphone!=null and user.userphone ne ''}">
                            <a href="/userCenter/gotoUpdatePhone_1" class="zhucek_mk colormk">修改</a>
                      </c:if>
                    </div>
                </div>
...
<jsp:include page="/userCenter/gotoHelp" />
<jsp:include page="/userCenter/gotoFoot" />
  </body>
</html>
