...
<div class="main_l">
    ...
    <div class="po_de">
        <div class="po_det">
            <ul>
                <li typeid="-2" class=""><a href="#" style="color:black;">积分明细</a></li>
                <li typeid="0" class=""><a href="#" style="color:black;">积分收入</a></li>
                <li typeid="-1" class="on"><a href="#" style="color:white;">积分支出</a></li>
            </ul>
            <div class="ck">
                <span>查看明细</span>
                    ...
                    <div style="display:none" id="jf_login_jf" class="jf_tc jf_tc_address">
                        ...
                        <div class="jf_box">
                            ...
                            <div class="jb_address">
                                ...
                                <ul>
                                        <li id="adressList">
                                            <a id="linkAdd" href="javascript:void(0)" onclick="updateAdresss(0)">添加</a>
                                        </li>
